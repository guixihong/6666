...
-(void)drawHu2
{
    ...
    CGContextAddArc(ctx, SCREENWIDTH/2 , SCREENHEIGHT/2, 80, -5*M_PI_4, end , 0);
...
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"hideClearup" object:nil];
...
void drawHu1()
{
    ...
    //2.设置路径
    CGContextAddArc(ctx, SCREENWIDTH/2 , SCREENHEIGHT/2, 80, -5*M_PI_4, M_PI_4, 0);
    //3.绘制
    CGContextStrokePath(ctx);
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _numLabel = [[UILabel alloc]initWithFrame:CGRectMake((SCREENWIDTH-120)/2, (SCREENHEIGHT-80)/2, 120, 80)];
