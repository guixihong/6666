...
-(void)setStarNumber:(NSInteger)starNumber{
    ...
    if([delegate respondsToSelector:@selector(setRating:isHuman: With:)]){
        [delegate setRating:_starNumber isHuman:NO With:self];
...
-(void)tap:(UITapGestureRecognizer *)gesture{
    ...
    if([delegate respondsToSelector:@selector(setRating:isHuman: With:)]){
        [delegate setRating:_starNumber isHuman:YES With:self];
    }
