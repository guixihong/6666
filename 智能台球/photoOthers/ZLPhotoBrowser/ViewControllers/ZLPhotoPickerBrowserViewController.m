...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(hideSelf) name:@"hideSelf" object:nil];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"currentPage" object:[NSString stringWithFormat:@"%lu",currentPage]];
