...
- (void)longGesture:(UILongPressGestureRecognizer *)gesture{
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        if (!self.sheet) {
            //分享
            self.sheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"保存到相册", nil];
...
//       [[NSNotificationCenter defaultCenter] postNotificationName:@"shareClick" object:nil];
//       [[NSNotificationCenter defaultCenter] postNotificationName:@"hideSelf" object:nil];
    }
}
...
//
//    currentIndex = scrollView.contentOffset.x/[UIScreen mainScreen].bounds.size.width;
//    NSLog(@"代理%lu",currentIndex);
//}
