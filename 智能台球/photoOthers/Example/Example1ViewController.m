...
- (void)setDataphotos:(NSArray *)imageUrlsArray{
...
//                          ];
        _urlArray = [NSMutableArray arrayWithArray:imageUrlsArray];
        _photos = [NSMutableArray arrayWithCapacity:imageUrlsArray.count];
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(shareClick) name:@"shareClick" object:nil];
    //@"currentPage"
...
-(void)currentPage:(NSNotification *)noti{
    ...
    currentPage = [noti.object integerValue];
    
}

//-(void)shareClick{
//    //@"http://111.200.41.23:8090/yblimg/gcys/201606/0007414003-0004-IMG_20160630_113701.jpg"
//    [[UMSocialData defaultData].urlResource setResourceType:UMSocialUrlResourceTypeImage url:_urlArray[currentPage]];
//    //[UIImage imageNamed:@"1.jpg"]
//    //    UMShareToQQ,UMShareToQzone
//    [UMSocialSnsService presentSnsIconSheetView:self
//                                         appKey:@"57871eb567e58eb284002ab0"
//                                      shareText:@"image"
//                                     shareImage:nil
